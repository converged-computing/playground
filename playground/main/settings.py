...
import playground.main.schemas
...
class Settings:
    ...
    def validate(self):
        ...
        """
        jsonschema.validate(
            instance=self._settings, schema=playground.main.schemas.settings
        )
    ...
    def edit(self, settings_file=None):
        ...
        if not editor:
            logger.exit(
                "No editors found! Update with playground config set config_editor:<name>"
            )
    ...
    def add(self, key, value):
        ...
        if value not in current:
            ...
            logger.warning(
                "Warning: Check with playground config edit - ordering of list can change."
            )
