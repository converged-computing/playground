...
def get_lookup():
    lookup = dict()
    version_file = os.path.join("playground", "version.py")
...
if __name__ == "__main__":
    ...
    INSTALL_REQUIRES_GOOGLE = get_reqs(lookup, "GOOGLE_CLOUD_REQUIRES")
    INSTALL_REQUIRES_AWS = get_reqs(lookup, "AWS_REQUIRES")
    INSTALL_REQUIRES_DOCKER = get_reqs(lookup, "DOCKER_REQUIRES")
    ...
    setup(
        ...
        extras_require={
            ...
            "docker": INSTALL_REQUIRES_DOCKER,
        },
        classifiers=[
        ...
        entry_points={"console_scripts": ["playground=playground.client:run"]},
    )
